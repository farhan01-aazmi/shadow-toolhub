...
export const pinterestTemplates = {
    ...
    crypto: (name: string, symbol: string, price: number) => ({
        ...
        description: `Live ${name} price update! 🚀 Currently trading at $${price.toLocaleString()}. track all movements on Tech Resolutions. #crypto #bitcoin #investing #blockchain`,
