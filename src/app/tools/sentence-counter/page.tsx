...
export const metadata: Metadata = {
    title: 'Sentence Counter Free Online | Tech Resolutions',
    description: 'Free online Sentence Counter tool. No signup required, works instantly in your browser.',
};
...
export default function SentenceCounterPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Sentence Counter</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Sentence Counter</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Sentence Counter. Fast, secure, and runs entirely in your browser.
            </p>
