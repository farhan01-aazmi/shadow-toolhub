...
export const metadata: Metadata = {
    title: 'Time Zone Converter Free Online | Tech Resolutions',
    description: 'Free online Time Zone Converter tool. No signup required, works instantly in your browser.',
};
...
export default function TimeZoneConverterPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span className="text-sub text-sm">Home &gt; Tools &gt; Time Zone Converter</span>
            </div>
            
            <h1 className="text-4xl font-bold mb-3 text-amber-500">Time Zone Converter</h1>
            <p className="text-sub text-lg mb-10">
                Free online Time Zone Converter. Fast, secure, and runs entirely in your browser.
            </p>
            ...
            <div className="card glass p-10 text-center my-10">
                ...
                <h3 className="text-2xl font-bold mb-3">Tool interface is loading...</h3>
