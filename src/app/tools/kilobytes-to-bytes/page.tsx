...
export const metadata: Metadata = {
    title: 'Kilobytes To Bytes - Free Online Universal Converter | Tech Resolutions',
    description: 'Convert Kilobytes to Bytes instantly with our free online tool. High accuracy, no signup required, 100% private.',
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Kilobytes To Bytes</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate kilobytes to bytes utility. Perfect for students, engineers, and professionals.
                </p>
                ...
                <div className="mt-16">
                    <h2>About Kilobytes To Bytes</h2>
