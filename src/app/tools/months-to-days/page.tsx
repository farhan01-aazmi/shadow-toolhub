...
export const metadata: Metadata = {
    title: 'Months To Days - Free Online Universal Converter | Tech Resolutions',
    description: 'Convert Months to Days instantly with our free online tool. High accuracy, no signup required, 100% private.',
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Months To Days</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate months to days utility. Perfect for students, engineers, and professionals.
                </p>
