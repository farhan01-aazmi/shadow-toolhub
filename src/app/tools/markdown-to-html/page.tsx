...
export const metadata: Metadata = {
    title: 'Markdown To Html Free Online | Tech Resolutions',
    description: 'Free online Markdown To Html tool. No signup required, works instantly in your browser.',
};
...
export default function MarkdownToHtmlPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Markdown To Html</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Markdown To Html</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Markdown To Html. Fast, secure, and runs entirely in your browser.
            </p>
