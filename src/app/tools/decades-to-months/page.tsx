...
export const metadata: Metadata = {
    title: 'Decades To Months - Free Online Universal Converter | Tech Resolutions',
    description: 'Convert Decades to Months instantly with our free online tool. High accuracy, no signup required, 100% private.',
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Decades To Months</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate decades to months utility. Perfect for students, engineers, and professionals.
                </p>
