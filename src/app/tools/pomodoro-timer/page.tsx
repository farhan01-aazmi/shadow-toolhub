...
export const metadata: Metadata = {
    title: 'Pomodoro Timer Free Online | Tech Resolutions',
    description: 'Free online Pomodoro Timer tool. No signup required, works instantly in your browser.',
};
...
export default function PomodoroTimerPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Pomodoro Timer</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Pomodoro Timer</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Pomodoro Timer. Fast, secure, and runs entirely in your browser.
            </p>
