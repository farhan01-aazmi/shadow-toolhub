...
export default function UnitConverterPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span className="text-sub text-sm">Home &gt; Tools &gt; Unit Converter</span>
            </div>
            
            <h1 className="text-4xl font-bold mb-3 text-amber-500">Unit Converter</h1>
            <p className="text-sub text-lg mb-10">
                Free online Unit Converter. Fast, secure, and runs entirely in your browser.
            </p>
