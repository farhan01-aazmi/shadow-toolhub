...
export const metadata: Metadata = {
    title: 'Beaufort To Mps - Free Online Universal Converter | Tech Resolutions',
    description: 'Convert Beaufort to Mps instantly with our free online tool. High accuracy, no signup required, 100% private.',
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Beaufort To Mps</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate beaufort to mps utility. Perfect for students, engineers, and professionals.
                </p>
