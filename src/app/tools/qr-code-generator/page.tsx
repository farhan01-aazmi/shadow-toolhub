...
export const metadata: Metadata = {
    title: 'Qr Code Generator Free Online | Tech Resolutions',
    description: 'Free online Qr Code Generator tool. No signup required, works instantly in your browser.',
};
...
export default function QrCodeGeneratorPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Qr Code Generator</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Qr Code Generator</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Qr Code Generator. Fast, secure, and runs entirely in your browser.
            </p>
