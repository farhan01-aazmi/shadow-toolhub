...
export const metadata: Metadata = {
    title: 'Password Generator Free Online | Nevy.in',
    description: 'Free online Password Generator tool. No signup required, works instantly in your browser.',
};
    ...
    return (
        <div className="container" style={{ padding: '60px 20px', maxWidth: '900px', margin: '0 auto', minHeight: '70vh' }}>
            <div style={{ marginBottom: '30px' }}>
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Password Generator</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Password Generator</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Password Generator. Fast, secure, and runs entirely in your browser.
            </p>
