...
export const metadata: Metadata = {
    title: 'Terahertz To Megahertz - Free Online Universal Converter | Tech Resolutions',
    description: 'Convert Terahertz to Megahertz instantly with our free online tool. High accuracy, no signup required, 100% private.',
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Terahertz To Megahertz</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate terahertz to megahertz utility. Perfect for students, engineers, and professionals.
                </p>
                ...
                <div style={{ marginTop: '60px' }}>
                    <h2>About Terahertz To Megahertz</h2>
