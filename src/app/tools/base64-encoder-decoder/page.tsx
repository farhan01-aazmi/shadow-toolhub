...
export const metadata: Metadata = {
    title: 'Base64 Encoder Decoder Free Online | Tech Resolutions',
    description: 'Free online Base64 Encoder Decoder tool. No signup required, works instantly in your browser.',
};
...
export default function Base64EncoderDecoderPage() {
    return (
        <div className="container" style={{ padding: '60px 20px', maxWidth: '900px', margin: '0 auto', minHeight: '70vh' }}>
            ...
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Base64 Encoder Decoder</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Base64 Encoder Decoder. Fast, secure, and runs entirely in your browser.
            </p>
