...
export const metadata: Metadata = {
    title: 'Mps To Light Speed - Free Online Universal Converter | Tech Resolutions',
    description: 'Convert Mps to Light Speed instantly with our free online tool. High accuracy, no signup required, 100% private.',
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Mps To Light Speed</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate mps to light speed utility. Perfect for students, engineers, and professionals.
                </p>
                ...
                <div style={{ marginTop: '60px' }}>
                    <h2>About Mps To Light Speed</h2>
