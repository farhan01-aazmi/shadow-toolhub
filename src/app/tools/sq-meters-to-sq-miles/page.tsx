    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Sq Meters To Sq Miles</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate sq meters to sq miles utility. Perfect for students, engineers, and professionals.
                </p>
                ...
                <div style={{ marginTop: '60px' }}>
                    <h2>About Sq Meters To Sq Miles</h2>
