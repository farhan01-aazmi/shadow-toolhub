...
export const metadata: Metadata = {
    title: 'Diff Checker Free Online | Tech Resolutions',
    description: 'Free online Diff Checker tool. No signup required, works instantly in your browser.',
};
    ...
    return (
        <div className="container" style={{ padding: '60px 20px', maxWidth: '900px', margin: '0 auto', minHeight: '70vh' }}>
            <div style={{ marginBottom: '30px' }}>
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Diff Checker</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Diff Checker</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Diff Checker. Fast, secure, and runs entirely in your browser.
            </p>
