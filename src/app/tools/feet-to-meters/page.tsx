...
export const metadata: Metadata = {
    title: 'Feet To Meters Free Online | Tech Resolutions',
    description: 'Free online Feet To Meters tool. No signup required, works instantly in your browser.',
};
    ...
    return (
        <div className="container" style={{ padding: '60px 20px', maxWidth: '900px', margin: '0 auto', minHeight: '70vh' }}>
            <div style={{ marginBottom: '30px' }}>
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Feet To Meters</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Feet To Meters</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Feet To Meters. Fast, secure, and runs entirely in your browser.
            </p>
