...
export const metadata: Metadata = {
    title: 'Merge Pdf Free Online | Tech Resolutions',
    description: 'Free online Merge Pdf tool. No signup required, works instantly in your browser.',
};
    ...
    return (
        <div className="container" style={{ padding: '60px 20px', maxWidth: '900px', margin: '0 auto', minHeight: '70vh' }}>
            <div style={{ marginBottom: '30px' }}>
                <span style={{ color: 'var(--sub)', fontSize: '0.9rem' }}>Home &gt; Tools &gt; Merge Pdf</span>
            </div>
            
            <h1 style={{ fontSize: '2.5rem', marginBottom: '10px', color: 'var(--amber)' }}>Merge Pdf</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '40px' }}>
                Free online Merge Pdf. Fast, secure, and runs entirely in your browser.
            </p>
