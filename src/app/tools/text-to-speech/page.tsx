...
export const metadata: Metadata = {
    title: 'Text To Speech Free Online | Tech Resolutions',
    description: 'Free online Text To Speech tool. No signup required, works instantly in your browser.',
};
...
export default function TextToSpeechPage() {
    return (
        <div className="container px-5 py-16 max-w-4xl mx-auto min-h-[70vh]">
            <div className="mb-8">
                <span className="text-sub text-sm">Home &gt; Tools &gt; Text To Speech</span>
            </div>
            
            <h1 className="text-4xl font-bold mb-3 text-amber-500">Text To Speech</h1>
            <p className="text-sub text-lg mb-10">
                Free online Text To Speech. Fast, secure, and runs entirely in your browser.
            </p>
