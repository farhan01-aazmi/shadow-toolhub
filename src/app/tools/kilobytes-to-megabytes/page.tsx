    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Kilobytes To Megabytes</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '40px' }}>
                    Quick and accurate kilobytes to megabytes utility. Perfect for students, engineers, and professionals.
                </p>
                ...
                <div className="mt-16">
                    <h2>About Kilobytes To Megabytes</h2>
