...
export const metadata: Metadata = {
    title: 'Terms of Service | Tech Resolutions',
    description: 'Read the Tech Resolutions terms and conditions. By using our free tools, you agree to these terms of service.',
    alternates: {
        canonical: 'https://www.nevy.in/terms-of-service',
    },
};
    ...
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                ...
                <p style={{ color: 'var(--text-secondary)', marginBottom: '30px' }}>Last updated: March 30, 2026</p>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', lineHeight: '1.8', color: 'var(--text-secondary)' }}>
                    <section>
                        ...
                        <p>By accessing and using Tech Resolutions, you accept and agree to be bound by these Terms of Service. If you do not agree, please do not use the site.</p>
                    </section>

                    <section>
                        <h2 style={{ color: 'var(--text-primary)', marginBottom: '10px' }}>2. Use of Services</h2>
                        <p>Tech Resolutions provides free online tools for personal and commercial use. You may not use our services for any illegal or unauthorized purpose. You must not attempt to disrupt or overload the service.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>All content, design, and functionality on Tech Resolutions are our intellectual property. You may not copy, redistribute, or repurpose our content without explicit written permission.</p>
                    </section>

                    <section>
                        <h2 style={{ color: 'var(--text-primary)', marginBottom: '10px' }}>5. Limitation of Liability</h2>
                        <p>Tech Resolutions shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use of our tools. All tools are provided &quot;as is&quot; without warranty of any kind.</p>
                    </section>
