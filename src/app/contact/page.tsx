    ...
    <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <div className="rv">
            ...
            <p style={{ marginTop: '20px', color: 'var(--text-secondary)' }}>
                We're here to help. Whether you have a question about our tools, want to suggest a new feature, or are interested in advertising on Tech Resolutions, we'd love to hear from you.
            </p>
