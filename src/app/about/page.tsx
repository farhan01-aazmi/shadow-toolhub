...
export const metadata: Metadata = {
    title: 'About Us - Privacy-First Online Tools | Tech Resolutions',
    description: 'Tech Resolutions is a privacy-first tool hub providing 70+ free online utilities with institutional-grade accuracy. No tracking, no signups. Built for speed and transparency.',
    alternates: {
...
export default function AboutPage() {
    return (
        <div className="container" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="rv">
                <h1 style={{ fontSize: '3rem', marginBottom: '20px', textAlign: 'center' }}>About Tech Resolutions</h1>
                ...
                <div style={{ display: 'grid', gap: '30px', marginBottom: '60px' }}>
                    <div className="card glass" style={{ padding: '30px' }}>
                        ...
                        <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
                            Tech Resolutions was built with one goal: to provide professionals, students, and everyday users with
